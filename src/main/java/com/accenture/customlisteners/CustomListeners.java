package com.accenture.customlisteners;
...
import static com.accenture.utility.Utility.takeScreenShot;
...
public class CustomListeners implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        reporter.config().setReportName("Accenture Report");
        ...
        reports.setSystemInfo("Maven", "3.9.1");
        reports.setSystemInfo("Java Version", "1.8.0_371");
